           ...
           new Container(
             ...
             child: (title) ? new Center(
               child: new AnimatedOpacity(opacity: (firstTitleShowing) ? animation.value : 1.0, duration: new Duration(seconds: 1),
                 child: (firstTitleShowing) ? new Text('Meet New People', style: new TextStyle(fontSize: 18.0,fontFamily: 'Link'),) : (secondTitleShowing) ? Text('Get Home', style: new TextStyle(fontSize: 18.0,fontFamily: 'Link' ),) : (thirdTitleShowing) ? Text('Link RideSharing', style: new TextStyle(fontSize: 18.0,fontFamily: 'Link'),):Text('', style: new TextStyle(fontSize: 18.0,fontFamily: 'Link'),)
               ),
             ) : new Container(),
           ),
